...
apt install -q -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" ntpdate autofs tree xvfb xdotool python python-pip software-properties-common wmctrl xclip ffmpeg sshfs rdesktop imagemagick nodejs npm maven lxde-core xinit
